 ...
 */
let walkingChallenges: [String] = ["Walk 5 miles a day", "Walk 7 miles a day"]
let runningChallenges: [String] = ["Run 7 miles a day", "Run 10 miles a day"]
