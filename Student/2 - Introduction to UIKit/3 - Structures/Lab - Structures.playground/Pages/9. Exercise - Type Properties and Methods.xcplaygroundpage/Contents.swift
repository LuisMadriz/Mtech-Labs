...
struct User {
    ...
    var email: String
    var age: Int
    static var user = "Luis"
    static func logIn(user: User) {
        print("The user \(user) is logged")
    }
    
}
var currentUser = User(userName: "Luis", email: "luis@hotmail.com", age: 25)
print(currentUser)
 ...
 */
User.logIn(user: User(userName: "Carlos", email: "carlos@gmail.com", age: 30))
