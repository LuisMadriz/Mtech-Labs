...
var average = RunningWorkout(distance: 1000, time: 3.50, elevation: 10)
print(average.averageMileTime)
/*:
...
let newSteps = Steps(steps: 9999, goal: 10000)
