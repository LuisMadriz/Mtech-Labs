...
var myFavoriteBook = Book(title: "Marketing 2.0", author: "Philip Kotler", pages: 350, price: 45.50)
print("Title: \(myFavoriteBook.title), Author: \(myFavoriteBook.author), Number of pages: \(myFavoriteBook.pages), Price: \(myFavoriteBook.price)")
/*:
...
let centimeters = Height(centimeters: 165.1)
print(centimeters.heightCentimeters)
print(centimeters.heightInches)
...
var someonesHeight = Height(inches: 65.00)
...
var myHeight = Height(centimeters: 187)
