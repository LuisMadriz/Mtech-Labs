 ...
 */
let nameInCaps: String = "Luis"
let name: String = "luis"

if nameInCaps == name {
    print("They two strings are equal")
}else {
...
if nameInCaps.lowercased() == name.lowercased() {
    print("<INSERT LOWERCASED VERSION OF \(nameInCaps) HERE> and <INSERT LOWERCASED OF \(name) HERE> are the same")
}else {
    print("<INSERT LOWERCASED VERSION OF \(nameInCaps) HERE> and <INSERT LOWERCASED OF \(name) HERE> are not the same")}
