...
let menuOptions: Bool = true
if menuOptions == hasFish && menuOptions == hasPizza && menuOptions == hasVegan {
    print("Let's go!")
} else {
    print("Sorry, we'll have to think of somewhere eslse")
}
...
if isRaining != isNiceWeather && temp >= 82 && isSunny == isNiceWeather {
