...
func add (number1: Int?, number2: Int?) -> Int? {
    guard let firstNumber = number1,
          let secondNumber = number2 else {
        return nil
    }
...
func createUser() -> User? {
    ...
    let user2 = User(firstName: theFirstName, lastName: theLastName, age: theAge)
    return user2
}
...
if let userThree = userTwo {
    print("\(userThree.firstName), \(userThree.lastName) is \(userThree.age)")
}
/*:
