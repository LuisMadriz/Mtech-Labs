...
print("because the value of foo is 55 and the for statement is looping until 9")
...
//the x value inside the loop is diferent to the value outside. The variable should have a diferent names.
...
greeting(greeting: "Hola", name: "Peter")
greeting(greeting: nil, name: "Peter")
