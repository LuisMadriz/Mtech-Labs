...
forwards(name1: "Cesar", name2: "Pablo")
...
var familyFriendsNames = ["Ana", "Benito", "Carlos", "Diego"]

var sortedCollection1 = familyFriendsNames.sorted(by: forwards(name1:name2:))
...
var sortedCollection2 = familyFriendsNames.sorted(by: { (firstName, secondName) -> Bool in
...
var sortedCollection3 = familyFriendsNames.sorted(by: <)
